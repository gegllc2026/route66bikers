...
// 2. Create a project to get your App ID
// 3. Replace AGORA_APP_ID below (never commit real keys to a public repo —
//    use environment variables / a config file that's git-ignored instead)
// 4. For production, generate temporary tokens server-side rather than
